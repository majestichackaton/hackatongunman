...
if (!window.Quantum) {
  Quantum = {
    ...
    _domain: {
      api: 'http://htgame.socialapps.co/webservices/api',
      rt: 'http://htgame.socialapps.co:8080/',
      rtHost: 'htgame.socialapps.co',
      rtPort: '8080',
      www      : window.location.protocol + '//htgame.socialapps.co/'
    },
    _locale: null,
    _localeIsRtl: false,
